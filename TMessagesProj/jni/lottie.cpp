...
JNIEXPORT jlong Java_com_creanger_app_ui_Components_RLottieNative_nCreate(JNIEnv *env, jclass clazz, jstring src, jstring json, jint w, jint h, jintArray data, jboolean precache, jintArray colorReplacement, jboolean limitFps, jint fitzModifier) {
...
JNIEXPORT jlong Java_com_creanger_app_ui_Components_RLottieNative_nGetFramesCount(JNIEnv *env, jclass clazz, jstring src, jstring json) {
    auto info = new LottieInfo();
    char const *srcString = env->GetStringUTFChars(src, nullptr);
    info->path = srcString;
    if (json != nullptr) {
...
JNIEXPORT jdouble Java_com_creanger_app_ui_Components_RLottieNative_nGetDuration(JNIEnv *env, jclass clazz, jstring src, jstring json) {
    auto info = new LottieInfo();
    char const *srcString = env->GetStringUTFChars(src, nullptr);
    info->path = srcString;
    if (json != nullptr) {
...
JNIEXPORT jlong Java_com_creanger_app_ui_Components_RLottieNative_nCreateWithJson(JNIEnv *env, jclass clazz, jstring json, jstring name, jintArray data, jintArray colorReplacement) {
    std::map<int32_t, int32_t> *colors = nullptr;
    if (colorReplacement != nullptr) {
        jint *arr = env->GetIntArrayElements(colorReplacement, nullptr);
        if (arr != nullptr) {
...
JNIEXPORT void Java_com_creanger_app_ui_Components_RLottieNative_nDestroy(JNIEnv *env, jclass clazz, jlong ptr) {
    if (!ptr) {
        return;
    }
...
JNIEXPORT void Java_com_creanger_app_ui_Components_RLottieNative_nSetLayerColor(JNIEnv *env, jclass clazz, jlong ptr, jstring layer, jint color) {
...
JNIEXPORT void Java_com_creanger_app_ui_Components_RLottieNative_nReplaceColors(JNIEnv *env, jclass clazz, jlong ptr, jintArray colorReplacement) {
...
JNIEXPORT jint Java_com_creanger_app_ui_Components_RLottieNative_nGetFrame(JNIEnv *env, jclass clazz, jlong ptr, jint frame, jobject bitmap, jboolean clear) {
