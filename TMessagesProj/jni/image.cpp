...
JNIEXPORT int Java_com_creanger_app_messenger_Utilities_needInvert(JNIEnv *env, jclass clazz, jobject bitmap, jint unpin, jint width, jint height, jint stride) {
    if (!bitmap) {
        return 0;
    }
...
JNIEXPORT void Java_com_creanger_app_messenger_Utilities_blurBitmap(JNIEnv *env, jclass clazz, jobject bitmap, jint radius, jint unpin, jint width, jint height, jint stride) {
    if (!bitmap) {
        return;
    }
...
JNIEXPORT void Java_com_creanger_app_messenger_Utilities_calcCDT(JNIEnv *env, jclass clazz, jobject hsvBuffer, jint width, jint height, jobject buffer, jobject calcBuffer) {
...
JNIEXPORT jint Java_com_creanger_app_messenger_Utilities_pinBitmap(JNIEnv *env, jclass clazz, jobject bitmap) {
    if (bitmap == nullptr) {
        return 0;
    }
    void *pixels;
...
JNIEXPORT void Java_com_creanger_app_messenger_Utilities_unpinBitmap(JNIEnv *env, jclass clazz, jobject bitmap) {
    if (bitmap == nullptr) {
        return;
    }
    AndroidBitmap_unlockPixels(env, bitmap);
...
JNIEXPORT void Java_com_creanger_app_messenger_Utilities_stackBlurBitmap(JNIEnv *env, jclass clazz, jobject bitmap, jint radius) {
    if (radius < 1) {
        return;
    }
...
JNIEXPORT void Java_com_creanger_app_messenger_Utilities_drawDitheredGradient(JNIEnv *env, jclass clazz, jobject bitmap, jintArray colors, jint startX, jint startY, jint endX, jint endY) {
    AndroidBitmapInfo info;
    void *pixelsBuffer;
    int reason;
...
//JNIEXPORT jint Java_com_creanger_app_messenger_Utilities_saveProgressiveJpeg(JNIEnv *env, jclass clazz, jobject bitmap, jint width, jint height, jint stride, jint quality, jstring path) {
...
JNIEXPORT void Java_com_creanger_app_messenger_Utilities_generateGradient(JNIEnv *env, jclass clazz, jobject bitmap, jboolean unpin, jint phase, jfloat progress, jint width, jint height, jint stride, jintArray colors) {
    if (!bitmap) {
        return;
    }
...
Java_com_creanger_app_messenger_Utilities_copyBitmaps(
        JNIEnv *env,
        jclass /*clazz*/,
        jobject src,
        jobject dst) {
...
// JNI entry point
//
// Kotlin: external fun applySoftLight(input: Bitmap, output: Bitmap, color: Int): Boolean  [com.creanger.app.messenger.Utilities]
//
...
// ---------------------------------------------------------------------------
JNIEXPORT jboolean JNICALL
Java_com_creanger_app_messenger_Utilities_applySoftLight(
        JNIEnv *env,
        jclass  /*clazz*/,
        jobject inputBitmap,
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_creanger_app_messenger_Utilities_nLibyuvARGBSaleBitmap(
        JNIEnv* env,
        jclass,
        jobject inputBitmap,
        jobject outputBitmap,
...
Java_com_creanger_app_messenger_Utilities_averageBitmapColor(
        JNIEnv* env,
        jclass,
        jobject bitmap,
        jint left,
