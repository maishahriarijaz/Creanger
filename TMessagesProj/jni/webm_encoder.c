...
JNIEXPORT jlong JNICALL Java_com_creanger_app_messenger_video_WebmEncoder_createEncoder(
...
JNIEXPORT jboolean JNICALL Java_com_creanger_app_messenger_video_WebmEncoder_writeFrame(
    JNIEnv *env, jobject obj,
    jlong ptr,
    jobject argbPixels,
    jint width, jint height
...
JNIEXPORT void JNICALL Java_com_creanger_app_messenger_video_WebmEncoder_stop(
    JNIEnv *env, jobject obj,
    jlong ptr
) {
    EncoderContext *ctx = (EncoderContext *) ptr;
