...
extern "C" JNIEXPORT jstring Java_com_creanger_app_messenger_Utilities_readlink(JNIEnv *env, jclass clazz, jstring path) {
...
extern "C" JNIEXPORT jstring Java_com_creanger_app_messenger_Utilities_readlinkFd(JNIEnv *env, jclass clazz, int fd) {
...
Java_com_creanger_app_messenger_Utilities_setupNativeCrashesListener(JNIEnv *env, jclass clazz,
                                                                 jstring path) {
