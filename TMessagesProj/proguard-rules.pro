...
-keep class com.creanger.app.messenger.* { *; }
-keep class com.creanger.app.messenger.camera.* { *; }
-keep class com.creanger.app.messenger.secretmedia.* { *; }
-keep class com.creanger.app.messenger.support.* { *; }
-keep class com.creanger.app.messenger.support.* { *; }
-keep class com.creanger.app.messenger.time.* { *; }
-keep class com.creanger.app.messenger.video.* { *; }
-keep class com.creanger.app.messenger.voip.* { *; }
-keep class com.creanger.app.SQLite.** { *; }
-keep class com.creanger.app.tgnet.ConnectionsManager { *; }
-keep class com.creanger.app.tgnet.NativeByteBuffer { *; }
-keep class com.creanger.app.tgnet.RequestDelegate { *; }
-keep class com.google.android.exoplayer2.ext.** { *; }
-keep class com.google.android.exoplayer2.extractor.FlacStreamMetadata { *; }
-keep class com.google.android.exoplayer2.metadata.flac.PictureFrame { *; }
-keep class com.google.android.exoplayer2.decoder.SimpleDecoderOutputBuffer { *; }
-keep class com.creanger.app.ui.Stories.recorder.FfmpegAudioWaveformLoader { *; }
