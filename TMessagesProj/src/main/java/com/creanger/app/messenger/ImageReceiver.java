...
import static com.creanger.app.messenger.ImageLoader.getHttpUrlExtension;
...
import com.creanger.app.ui.Components.AttachableDrawable;
import com.creanger.app.ui.Components.AvatarDrawable;
import com.creanger.app.ui.Components.ClipRoundedDrawable;
import com.creanger.app.ui.Components.CubicBezierInterpolator;
import com.creanger.app.ui.Components.LoadingStickerDrawable;
import com.creanger.app.ui.Components.RLottieDrawable;
import com.creanger.app.ui.Components.RecyclableDrawable;
        ...
        if (object instanceof TLRPC.User) {
            ...
            if (user.photo != null) {
                ...
                if (vectorType == VectorAvatarThumbDrawable.TYPE_STATIC) {
                    ...
                    if (userFull != null) {
                        TLRPC.Photo photo = user.photo.personal ? userFull.personal_photo : userFull.fallback_photo;
                        if (photo != null) {
