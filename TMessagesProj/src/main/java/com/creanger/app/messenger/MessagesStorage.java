...
import static com.creanger.app.messenger.MessagesController.LOAD_AROUND_DATE;
import static com.creanger.app.messenger.MessagesController.LOAD_AROUND_MESSAGE;
import static com.creanger.app.messenger.MessagesController.LOAD_BACKWARD;
import static com.creanger.app.messenger.MessagesController.LOAD_FORWARD;
import static com.creanger.app.messenger.MessagesController.LOAD_FROM_UNREAD;
...
import com.creanger.app.tgnet.tl.TL_communities;
...
import com.creanger.app.ui.EditWidgetActivity;
...
public class MessagesStorage extends BaseController {
            ...
            try {
                ...
                while (cursor.next()) {
                    ...
                    if (data != null) {
                        ...
                        switch (type) {
                            case 0: {
        // purged: Telegram TLdeserialize removed
                                if (chat != null) {
    ...
    public void putPushMessage(MessageObject message) {
        ...
        // purged: Telegram serializeToStream removed
...
*/
            ...
            for (int a = 0; a < 2; a++) {
                final boolean isMain = a == 0;
                final boolean isArchive = a == 1;
                int flags = MessagesController.DIALOG_FILTER_FLAG_ALL_CHATS;
                if (isMain) {
    ...
    public ArrayList<TLRPC.EphemeralMessage> getEphemeralMessagesInternal(long dialogId, ArrayList<Integer> ids) {
        ...
        try {
            ...
            while (cursor.next()) {
                ...
                TLRPC.EphemeralMessage message = null;
        // purged: Telegram TLdeserialize removed
