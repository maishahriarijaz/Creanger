...
public class DownloadController extends BaseController implements NotificationCenter.NotificationCenterDelegate {
    ...
    private int canDownloadMediaInternal(MessageObject message) {
        ...
        if (message.messageOwner.params != null && message.messageOwner.params.containsKey(CreangerChatDetection.ARG_CREANGER_CHAT_ID)) {
            return 0; // No auto-download for Creanger media (handled by Creanger data plane)
        }
