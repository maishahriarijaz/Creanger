...
MESSAGE_STATUS,
    ...
    private static Result modernReaction(JSONObject data) {
        ...
        MessageReaction reaction = new MessageReaction(
                ...
                record.optString("reaction", null),
                record.optBoolean("is_custom_emoji", false),
                record.isNull("custom_emoji_id") ? null : record.optString("custom_emoji_id", null),
                record.isNull("created_at") ? null : record.optString("created_at", null),
                record.isNull("updated_at") ? null : record.optString("updated_at", null));
    ...
    private static Result messageFromRecord(String subscribedChatId, JSONObject record, Kind kind) {
        ...
        CreangerMessage message = new CreangerMessage(
                pickId(record),
                chatId,
                record.optString("sender_id", null),
                record.optString("message_type", MessageType.TEXT),
                nullIfEmpty(record.optString("content", null)),
                record.optString("status", MessageStatus.SENT),
