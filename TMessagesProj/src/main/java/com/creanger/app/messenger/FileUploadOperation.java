...
//                }
        ...
        if (slowNetwork) {
            ...
            connectionType = ConnectionsManager.ConnectionTypeUpload | ConnectionsManager.ConnectionTypeGeneric;
        }
        long time = System.currentTimeMillis();
        int[] requestToken = new int[1];
        requestToken[0] = ConnectionsManager.getInstance(currentAccount).sendRequest(finalRequest, (RequestDelegate) (response, error) -> {
