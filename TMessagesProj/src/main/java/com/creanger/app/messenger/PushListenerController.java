                ...
                try {
                    ...
                    switch (loc_key) {
                        ...
                        case "MESSAGE_ANNOUNCEMENT": {
                            ...
                            final TLRPC.Updates updates = new TLRPC.TL_updates();
                            ((TLRPC.TL_updates) updates).updates.add(update);
                        ...
                        case "OAUTH_REQUEST": {
                            ...
                            final MessageObject messageObject = new MessageObject(currentAccount, (TLRPC.Message) messageOwner, messageText, data_url, null, true, false, false, false);
                        ...
                        if ("READ_HISTORY".equals(loc_key)) {
                            ...
                            if (processNotification) {
                                ...
                                if (messageText != null) {
                                    ...
                                    MessageObject messageObject = new MessageObject(currentAccount, (TLRPC.Message) messageOwner, messageText, name, userName, localMessage, channel, supergroup, edited);
                                    if (topicId != 0) {
