...
import com.creanger.app.messenger.support.SparseLongArray;
...
import com.creanger.app.tgnet.NativeByteBuffer;
...
import com.creanger.app.ui.Components.poll.PollSendParams;
import com.creanger.app.ui.Components.poll.attached.PollAttachedMediaFile;
import com.creanger.app.ui.Components.poll.attached.PollAttachedMediaGallery;
import com.creanger.app.ui.Components.poll.attached.PollAttachedMediaLink;
import com.creanger.app.ui.Components.poll.attached.PollAttachedMediaLocation;
import com.creanger.app.ui.Components.poll.attached.PollAttachedMediaMusic;
import com.creanger.app.ui.Components.poll.attached.PollAttachedMediaSticker;
import com.creanger.app.ui.LaunchActivity;
import com.creanger.app.ui.OAuthSheet;
import com.creanger.app.ui.Stars.StarsController;
import com.creanger.app.ui.Stars.StarsIntroActivity;
import com.creanger.app.ui.Stars.StarsNeededSheet;
...
import com.creanger.app.ui.PaymentFormActivity;
import com.creanger.app.ui.Stories.MessageMediaStoryFull;
import com.creanger.app.ui.TwoStepVerificationActivity;
import com.creanger.app.ui.TwoStepVerificationSetupActivity;
    ...
    protected class DelayedMessage {
        ...
        public void sendDelayedRequests() {
            ...
            for (int a = 0; a < size; a++) {
                ...
                if (false && false && request.request instanceof TLRPC.TL_messages_sendEncryptedMultiMedia) {
                    getSecretChatHelper().performSendEncryptedRequest((TLRPC.TL_messages_sendEncryptedMultiMedia) request.request, this);
                } else if (false && false && request.request instanceof TLRPC.TL_messages_sendMultiMedia) {
                ...
                } else if (false && false && request.request instanceof TLRPC.TL_messages_sendMedia && ((TLRPC.TL_messages_sendMedia) request.request).media instanceof TLRPC.TL_inputMediaPaidMedia) {
                ...
                } else if (false && false && request.request instanceof TLRPC.TL_messages_sendMedia && ((TLRPC.TL_messages_sendMedia) request.request).media instanceof TLRPC.TL_inputMediaPoll) {
                    performSendMessageRequestMulti((TLRPC.TL_messages_sendMedia) request.request, request.msgObjs, request.originalPaths, request.parentObjects, request.delayedMessage, request.scheduled);
                } else {
        ...
        if (id == NotificationCenter.fileUploadProgressChanged) {
            ...
            if (arr != null) {
                for (int a = 0; a < arr.size(); a++) {
                    ...
                    if (false && false && message.sendRequest instanceof TLRPC.TL_messages_sendMedia) {
                    ...
                    } else if (false && false && message.sendRequest instanceof TLRPC.TL_messages_editMessage) {
                        media = ((TLRPC.TL_messages_editMessage) message.sendRequest).media;
                    } else if (false && false && message.sendRequest instanceof TLRPC.TL_messages_sendMultiMedia) {
                        media = (TLRPC.InputMedia) message.extraHashMap.get(location);
                    } else if (false && false && message.sendRequest instanceof TLRPC.TL_messages_addPollAnswer) {
                ...
                for (int a = 0; a < messages.size(); a++) {
                    ...
                    if (message.type == 4) {
                        ...
                        if (index >= 0) {
                            ...
                            if (false && false && message.sendRequest instanceof TLRPC.TL_messages_sendMultiMedia) {
                            ...
                            } else if (false && false && message.sendRequest instanceof TLRPC.TL_messages_sendMedia && ((TLRPC.TL_messages_sendMedia) message.sendRequest).media instanceof TLRPC.TL_inputMediaPaidMedia) {
                            ...
                            } else if (false && false && message.sendRequest instanceof TLRPC.TL_messages_sendMedia && ((TLRPC.TL_messages_sendMedia) message.sendRequest).media instanceof TLRPC.TL_inputMediaPoll) {
                                TLRPC.TL_messages_sendMedia request = (TLRPC.TL_messages_sendMedia) message.sendRequest;
...
//                            }
                ...
                if (document != null) {
                    if (message.videoEditedInfo != null && message.videoEditedInfo.needConvert() && message.performMediaUpload) {
                        ...
                        if (message.sendRequest != null) {
                            ...
                            } else if (false && false && message.sendRequest instanceof TLRPC.TL_messages_sendMedia) {
                                TLRPC.TL_messages_sendMedia request = (TLRPC.TL_messages_sendMedia) message.sendRequest;
                                peer = request.peer;
                            ...
                            if (media != null && media.file == null && !(media instanceof TLRPC.TL_inputMediaDocument) && message.performMediaUpload) {
                                ...
                                putToUploadingMessages(messageObject);
                                    ...
                                    && false && message.sendRequest instanceof TLRPC.TL_messages_sendMultiMedia
    ...
    private void uploadMultiMedia(final DelayedMessage message, final TLRPC.InputMedia inputMedia, final TLRPC.InputEncryptedFile inputEncryptedFile, String key) {
        // Legacy Telegram media upload was replaced by the Creanger media pipeline
        // (CreangerMessageAsync -> Creanger Media API -> ImageBB/Cloudinary server-side).
        // Only the secret-chat legacy bookkeeping below is still driven from here.
