...
public class BuildVars {
    ...
    // TODO (Part 3 of fix guide): replace with YOUR OWN credentials from https://my.telegram.org
    // Do not ship a build with these placeholder values - obtain your own api_id/api_hash first.
    public static int APP_ID = 31084206;
    public static String APP_HASH = "7858baf2a8b5278b52a199b44b59489c";

    // SafetyNet key for Google Identity SDK, set it to empty to disable
    public static String SAFETYNET_KEY = "AIzaSyDqt8P-7F7CPCseMkOiVRgb1LY8RN1bvH8";
    public static String PLAYSTORE_APP_URL = "https://play.google.com/store/apps/details?id=com.creanger.app.messenger";
    ...
    public static boolean isBetaApp() {
        if (betaApp == null) {
            betaApp = ApplicationLoader.applicationContext != null && "com.creanger.app.messenger.beta".equals(ApplicationLoader.applicationContext.getPackageName());
        }
        return betaApp;
    }
