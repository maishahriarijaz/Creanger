...
import static com.creanger.app.tgnet.TLObject.hasFlag;
import static com.creanger.app.tgnet.TLObject.setFlag;
...
import com.creanger.app.ui.ArticleViewer;
...
import com.creanger.app.ui.Components.ReplyMessageLine;
...
import com.creanger.app.ui.SettingsActivity;
...
public class RichMessageLayout {
    ...
    private com.creanger.app.ui.Components.Text showMoreText;
...
//                }
    ...
    private void drawShowMoreButton(Canvas canvas, int contentBottom) {
        ...
        if (showMoreText == null) {
            showMoreText = new com.creanger.app.ui.Components.Text(LocaleController.getString(R.string.ShowMore), 16, AndroidUtilities.bold());
        }
    ...
    public CharSequence formatText(TL_iv.RichText text, SpannableStringBuilder out, int flags) {
        if (text instanceof TL_iv.textEmpty) {
            ...
            formatTextAndSetSpan(text.text, out, flags, new URLSpanNoUnderline(getString(text)));
    ...
    public static class RichSlideshowBlock extends RichBlock {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (slideDotDrawable == null && view != null) {
                slideDotDrawable = view.getResources().getDrawable(com.creanger.app.messenger.R.drawable.slide_dot_small);
                slideDotBigDrawable = view.getResources().getDrawable(com.creanger.app.messenger.R.drawable.slide_dot_big);
            }
            final boolean inQuote = isInQuote();
            final int pad = dp(2);
            final int padL = inQuote ? 0 : root.padLeft - pad;
