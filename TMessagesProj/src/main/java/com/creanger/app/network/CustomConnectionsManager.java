...
public class CustomConnectionsManager implements CustomNetworkInterface {
    ...
    private static final CustomConnectionsManager[] Instances = new CustomConnectionsManager[UserConfig.MAX_ACCOUNT_COUNT];
    private static final Object[] LockObjects = new Object[UserConfig.MAX_ACCOUNT_COUNT];
    static {
        for (int i = 0; i < UserConfig.MAX_ACCOUNT_COUNT; i++) LockObjects[i] = new Object();
    }
