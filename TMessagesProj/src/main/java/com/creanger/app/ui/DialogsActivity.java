...
import static com.creanger.app.ui.Components.AlertsCreator.createClearOrDeleteDialogsAlert;
...
import com.creanger.app.messenger.BotWebViewVibrationEffect;
...
import com.creanger.app.messenger.FilesMigrationService;
...
import com.creanger.app.messenger.XiaomiUtilities;
import com.creanger.app.messenger.browser.Browser;
import com.creanger.app.messenger.utils.FBool;
import com.creanger.app.messenger.utils.GradientProtectionDrawable;
import com.creanger.app.messenger.utils.SearchTextWatcher;
...
import com.creanger.app.ui.ActionBar.MenuDrawable;
...
import com.creanger.app.ui.Adapters.DialogsAdapter;
import com.creanger.app.ui.Adapters.DialogsSearchAdapter;
import com.creanger.app.ui.Adapters.FiltersView;
import com.creanger.app.ui.Cells.AnimatedStatusView;
import com.creanger.app.ui.Cells.ArchiveHintInnerCell;
import com.creanger.app.ui.Cells.DialogCell;
import com.creanger.app.ui.Cells.DialogsEmptyCell;
import com.creanger.app.ui.Cells.DialogsHintCell;
import com.creanger.app.ui.Cells.GraySectionCell;
import com.creanger.app.ui.Cells.HashtagSearchCell;
import com.creanger.app.ui.Cells.HeaderCell;
import com.creanger.app.ui.Cells.HintDialogCell;
import com.creanger.app.ui.Cells.LoadingCell;
import com.creanger.app.ui.Cells.ProfileSearchCell;
import com.creanger.app.ui.Cells.RequestPeerRequirementsCell;
...
import com.creanger.app.ui.Cells.UnconfirmedAuthHintCell;
...
import com.creanger.app.ui.Components.ArchiveHelp;
import com.creanger.app.ui.Components.AvatarDrawable;
import com.creanger.app.ui.Components.BackupImageView;
import com.creanger.app.ui.Components.BlurredRecyclerView;
import com.creanger.app.ui.Components.ColoredImageSpan;
import com.creanger.app.ui.Components.DialogsActivityStatusLayout;
import com.creanger.app.ui.Components.DialogsActivityTopBubblesFadeView;
import com.creanger.app.ui.Components.DialogsActivityTopPanelLayout;
import com.creanger.app.ui.Components.FragmentFloatingButton;
import com.creanger.app.ui.Components.FragmentSearchField;
import com.creanger.app.ui.Components.IconBackgroundColors;
import com.creanger.app.ui.Components.ImageUpdater;
import com.creanger.app.ui.Components.PermissionRequest;
...
import com.creanger.app.ui.Components.blur3.BlurredBackgroundWithFadeDrawable;
import com.creanger.app.ui.Components.blur3.DownscaleScrollableNoiseSuppressor;
import com.creanger.app.ui.Components.blur3.RenderNodeWithHash;
import com.creanger.app.ui.Components.blur3.capture.IBlur3Capture;
import com.creanger.app.ui.Components.blur3.capture.IBlur3Hash;
...
import com.creanger.app.ui.Components.blur3.source.BlurredBackgroundSource;
...
import com.creanger.app.ui.Components.blur3.utils.Blur3Utils;
import com.creanger.app.ui.Components.chat.ChatInputViewsContainer;
import com.creanger.app.ui.Components.chat.ViewPositionWatcher;
import com.creanger.app.ui.Components.chat.layouts.ChatActivityFadeView;
import com.creanger.app.ui.Components.inset.WindowInsetsStateHolder;
import com.creanger.app.ui.Gifts.GiftSheet;
import com.creanger.app.ui.Stories.StealthModeAlert;
...
import com.creanger.app.ui.Components.ChatActivityEnterView;
...
import com.creanger.app.ui.Components.DialogsItemAnimator;
...
import com.creanger.app.ui.Components.FloatingDebug.FloatingDebugProvider;
import com.creanger.app.ui.Components.ForegroundColorSpanThemable;
import com.creanger.app.ui.Components.Forum.ForumUtilities;
import com.creanger.app.ui.Components.FragmentContextView;
...
import com.creanger.app.ui.Components.NumberTextView;
import com.creanger.app.ui.Components.PacmanAnimation;
import com.creanger.app.ui.Components.Premium.LimitReachedBottomSheet;
...
import com.creanger.app.ui.Components.PullForegroundDrawable;
...
import com.creanger.app.ui.Components.RecyclerAnimationScrollHelper;
import com.creanger.app.ui.Components.RecyclerItemsEnterAnimator;
import com.creanger.app.ui.Components.RecyclerListView;
import com.creanger.app.ui.Components.SearchViewPager;
import com.creanger.app.ui.Components.ShareTopView;
...
import com.creanger.app.ui.Components.StickersAlert;
import com.creanger.app.ui.Components.SwipeGestureSettingsView;
import com.creanger.app.ui.Components.UndoView;
import com.creanger.app.ui.Components.ViewPagerFixed;
import com.creanger.app.ui.Stories.DialogStoriesCell;
import com.creanger.app.ui.Stories.StoriesController;
import com.creanger.app.ui.Stories.StoriesListPlaceProvider;
import com.creanger.app.ui.Stories.UserListPoller;

import com.creanger.app.ui.Stories.recorder.StoryRecorder;
import com.creanger.app.ui.community.CommunityChatType;
import com.creanger.app.ui.community.CommunityEditActivity;
import com.creanger.app.ui.community.CommunityPendingRequestsActivity;
import com.creanger.app.ui.community.CommunityUtils;
import com.creanger.app.ui.community.cells.CommunityRequestsCell;
...
//            }
                ...
                if (animationSupportListView != null) {
                    ...
                    if (anchorView != null) {
                        ...
                        if (p >= 0) {
                            ...
                            int fixedOffset = adapter.fixScrollGap(this, p, offset, hasArchive, hasStories, false, opened);
    ...
    private void updateContextViewPosition() {
        ...
        if (topBubblesFadeView != null) {
            ...
            final float s = lerp(dp(7), dp(50), Math.min(topPanelsVisibility, 0f));
            topBubblesFadeView.setPosition(s, Math.min(dp(40), topPanelsHeight - s));
            topBubblesFadeView.setAlpha(Math.max(0f, topPanelsVisibility));
        }
    }
    ...
    /**
     * Refreshes the Creanger section of every dialog list page from the chat
     * repository (background thread) and publishes the cached chats on the UI
     * thread. No-op unless the Creanger auth layer is enabled and
     * authenticated; failures keep the last cached rows (or none).
     */
    private void updateCreangerChats() {
        if (viewPages == null || !BuildConfig.USE_CREANGER_AUTH) {
            return;
        }
        CreangerAuth auth;
        try {
        ...
        // A recreated adapter starts empty: always post whatever is cached
        // (possibly empty after a true logout), then refresh when possible.
        // Stale rows beat an empty list; refresh replaces them on success.
        final boolean canRefresh = auth.getState() == AuthState.AUTHENTICATED;
        ...
        Utilities.globalQueue.postRunnable(() -> {
            ...
            // the write and the read (e.g. profile state changes), which would
            // wrongly wipe a healthy list. On failure keep showing last rows.
            java.util.List<CreangerChat> fresh = null;
            if (canRefresh) {
                try {
                    fresh = chatRepository.refreshChats();
                } catch (Exception ignore) {
                }
            }
            final java.util.List<CreangerChat> chats;
            try {
                chats = fresh != null ? fresh : chatRepository.getCachedChats();
            } catch (Exception ignore) {
                return;
            }
            ...
            try {
                String myId = null;
                try {
                    com.creanger.app.messenger.creanger.model.AuthModels.CreangerUser me =
                            engine.currentUser();
    ...
    private void onItemClick(View view, int position, RecyclerListView.Adapter adapter, float x, float y) {
        ...
        if (adapter instanceof DialogsAdapter) {
            ...
            if (object instanceof TLRPC.User) {
                ...
                return;
            } else if (object instanceof CreangerChat) {
                CreangerChat creangerChat = (CreangerChat) object;
...
//            }
        ...
        for (int a = 0; a < count; a++) {
            ...
            if (action == pin || action == pin2) {
                if (canPinCount != 0) {
                    ...
                    pinnedActionCount++;
                    pinDialog(selectedDialog, true, count == 1);
                } else {
                    if (!isDialogPinned(dialog)) {
                        continue;
                    }
                    pinnedActionCount++;
                    pinDialog(selectedDialog, false, count == 1);
                }
            } else if (action == read) {
                if (canReadCount != 0) {
    ...
    private void pinDialog(long selectedDialog, boolean pin, boolean animated) {
        ...
        boolean updated = getMessagesController().pinDialog(selectedDialog, pin, null, -1);
...
//            }
    ...
    private void showItemOptions() {
        ...
        // Creanger: Channels preserved alongside Groups.
        io.add(R.drawable.outline_groups_24, getString(R.string.NewChannel), () -> {
            Bundle args = new Bundle();
            args.putInt("step", 0);
    ...
    // Chat folder ecosystem removed - stub method
