...
import static com.creanger.app.messenger.LocaleController.formatPluralStringSpaced;
...
import static com.creanger.app.ui.ChatEditActivity.applyNewSpan;
import static com.creanger.app.ui.Stars.StarsIntroActivity.StarsTransactionView.getPlatformDrawable;
import static com.creanger.app.ui.Components.FeatureCells.percents;
...
import com.creanger.app.ui.Cells.SessionCell;
import com.creanger.app.ui.ChatActivity;
import com.creanger.app.ui.ChatUsersActivity;
...
import com.creanger.app.ui.Components.LoadingSpan;
...
import com.creanger.app.ui.Components.StarAppsSheet;
import com.creanger.app.ui.Components.TableView;
...
import com.creanger.app.ui.GradientHeaderActivity;
import com.creanger.app.ui.ImageReceiverSpan;
import com.creanger.app.ui.LaunchActivity;
import com.creanger.app.ui.PhotoViewer;
import com.creanger.app.ui.PostSuggestionsEditActivity;
import com.creanger.app.ui.PrivacyControlActivity;
...
//            || id == NotificationCenter.starTransactionsLoaded
    ...
    public View createView(Context context) {
        ...
        configureHeader(getString(R.string.TelegramStars), AndroidUtilities.replaceArrows(getString(R.string.TelegramStarsInfo2), true), aboveTitleView, null);
    ...
    public static class StarsTransactionView extends LinearLayout {
        ...
        public void set(TL_stars.StarsTransaction transaction, boolean bot, boolean divider) {
            ...
            threeLines = did != 0 && !transaction.posts_search || transaction.subscription || transaction.floodskip || transaction.gift && transaction.peer instanceof TL_stars.TL_starsTransactionPeerFragment;
...
//            }
    ...
    public static BottomSheet showTransactionSheet(Context context, boolean bot, long dialogId, int currentAccount, TL_stars.StarsTransaction transaction, Theme.ResourcesProvider resourcesProvider) {
        ...
        LinearLayout linearLayout = new LinearLayout(context);
        linearLayout.setOrientation(LinearLayout.VERTICAL);
linearLayout.setPadding(0, dp(giveaway || transaction.gift ? 0 : 20), 0, dp(8));
