...
import static com.creanger.app.ui.Components.Premium.LimitReachedBottomSheet.TYPE_ACCOUNTS;
...
//        checkUi_fadeView();
    ...
    public boolean onFragmentCreate() {
        ...
        // Every entry to the main UI (fresh login and cold restart) must see
        // the persisted Creanger self user in MessagesController; otherwise
        // userId-based screens (self Profile page, avatars) take missing-user
        // paths. No-op unless Creanger mode with a stored user.
        try {
            com.creanger.app.messenger.creanger.ui.CreangerLoginFlowHelper.ensureSelfPublished(
