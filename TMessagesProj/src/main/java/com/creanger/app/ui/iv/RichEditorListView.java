...
import com.creanger.app.messenger.AppGlobalConfig;
...
public class RichEditorListView extends UniversalRecyclerView {
    ...
    private MediaUploadState resolveBlockMedia(TL_iv.PageBlock block) {
        if (block instanceof TL_iv.pageBlockAudio) {
            ...
            final TLRPC.PhotoSize big = com.creanger.app.messenger.FileLoader.getClosestPhotoSizeWithSize(photo.sizes, AndroidUtilities.getPhotoSize());
            if (big != null) {
                media.width = big.w;
                media.height = big.h;
            }
