...
import com.creanger.app.ui.Cells.TextCheckCell2;
...
import com.creanger.app.ui.Components.GigagroupConvertAlert;
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public int getItemViewType(int position) {
            if (position == addNewRow || position == addNew2Row || position == recentActionsRow || position == gigaConvertRow) {
                ...
                return 5;
            } else if (position == participantsInfoRow || position == slowmodeInfoRow || position == gigaInfoRow || position == antiSpamInfoRow || position == hideMembersInfoRow || position == tagsInfoRow || position == signMessagesInfoRow || position == payInfoRow || position == priceInfoRow) {
                return 1;
