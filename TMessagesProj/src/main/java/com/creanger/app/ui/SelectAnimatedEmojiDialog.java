...
import com.creanger.app.ui.Cells.FixedHeightEmptyCell;
...
import com.creanger.app.ui.Components.CloseProgressDrawable2;
import com.creanger.app.ui.Components.CubicBezierInterpolator;
import com.creanger.app.ui.Components.DrawingInBackgroundThreadDrawable;
import com.creanger.app.ui.Components.EditTextCaption;
import com.creanger.app.ui.Components.EmojiPacksAlert;
import com.creanger.app.ui.Components.EmojiTabsStrip;
...
import com.creanger.app.ui.Components.Premium.PremiumLockIconView;
import com.creanger.app.ui.Components.RLottieImageView;
import com.creanger.app.ui.Components.Reactions.HwEmojis;
...
import com.creanger.app.ui.Components.SearchStateDrawable;
import com.creanger.app.ui.Components.StickerCategoriesListView;
...
//                        index--;
            ...
            public boolean onItemClick(View view, int position, float x, float y) {
                ...
                if (view instanceof ImageViewEmoji && (type == TYPE_REACTIONS || type == TYPE_EXPANDABLE_REACTIONS)) {
                    ...
                    if (!imageViewEmoji.isDefaultReaction && !UserConfig.getInstance(currentAccount).isPremium()) {
                        ...
                        onEmojiSelected(imageViewEmoji, imageViewEmoji.span.documentId, document, null, null);
                        return true;
                    }
                ...
                if (view instanceof ImageViewEmoji && ((ImageViewEmoji) view).span != null && (type == TYPE_EMOJI_STATUS || type == TYPE_EMOJI_STATUS_TOP || type == TYPE_EMOJI_STATUS_CHANNEL || type == TYPE_EMOJI_STATUS_CHANNEL_TOP)) {
                    SelectStatusDurationDialog dialog = selectStatusDateDialog = new SelectStatusDurationDialog(context, dismiss, SelectAnimatedEmojiDialog.this, (ImageViewEmoji) view, resourcesProvider) {
                        ...
                        protected void onEndPartly(Integer date) {
                            ...
                            onEmojiSelected(view, status.document_id, ((ImageViewEmoji) view).span.document, null, date);
    ...
    private void onStickerClick(ImageViewEmoji viewEmoji, TLRPC.Document document) {
        if (type == TYPE_CHAT_REACTIONS) {
            onEmojiSelected(viewEmoji, document.id, document, null, null);
        } else {
            onEmojiSelected(viewEmoji, null, document, null, null);
        }
    }
        ...
        if (span == null || (type == TYPE_EMOJI_STATUS || type == TYPE_EMOJI_STATUS_TOP || type == TYPE_EMOJI_STATUS_CHANNEL || type == TYPE_EMOJI_STATUS_CHANNEL_TOP) && selectedDocumentIds.contains(span.documentId)) {
            ...
            if (view instanceof ImageViewEmoji) {
                ...
                if (type == TYPE_EMOJI_STATUS || type == TYPE_EMOJI_STATUS_TOP || type == TYPE_EMOJI_STATUS_CHANNEL || type == TYPE_EMOJI_STATUS_CHANNEL_TOP || type == TYPE_SET_DEFAULT_REACTION) {
                    if (!willApplyEmoji(view, span.documentId, document, null, null)) {
