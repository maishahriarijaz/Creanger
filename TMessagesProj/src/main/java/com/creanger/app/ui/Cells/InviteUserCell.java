...
import com.creanger.app.ui.Components.ProgressButton;
...
public class InviteUserCell extends FrameLayout {
    ...
    public void update(int mask) {
        ...
        if (currentContact.imported) {
            statusTextView.setText(LocaleController.formatPluralString("TelegramContacts", 1));
        } else {
