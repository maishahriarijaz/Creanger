...
public class SharedMediaLayout extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, DialogCell.DialogCellDelegate {
    // Local stubs for purged messenger dependencies
    private static int dp(float v) { return (int) v; }
    private static int dp(int v) { return v; }
    private static String getString(int resId) { return ""; }
