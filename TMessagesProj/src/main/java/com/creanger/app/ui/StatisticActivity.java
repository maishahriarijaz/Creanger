...
import com.creanger.app.messenger.LruCache;
...
import com.creanger.app.ui.Cells.ManageChatTextCell;
import com.creanger.app.ui.Cells.ShadowSectionCell;
import com.creanger.app.ui.Cells.StatisticPostInfoCell;
import com.creanger.app.ui.Charts.BarChartView;
import com.creanger.app.ui.Charts.BaseChartView;
import com.creanger.app.ui.Charts.DoubleLinearChartView;
import com.creanger.app.ui.Charts.LinearBarChartView;
import com.creanger.app.ui.Charts.LinearChartView;
import com.creanger.app.ui.Charts.PieChartView;
import com.creanger.app.ui.Charts.StackBarChartView;
import com.creanger.app.ui.Charts.StackLinearChartView;
import com.creanger.app.ui.Charts.data.ChartData;
import com.creanger.app.ui.Charts.data.DoubleLinearChartData;
import com.creanger.app.ui.Charts.data.StackBarChartData;
import com.creanger.app.ui.Charts.data.StackLinearChartData;
import com.creanger.app.ui.Charts.view_data.ChartHeaderView;
import com.creanger.app.ui.Charts.view_data.LineViewData;
import com.creanger.app.ui.Charts.view_data.TransitionParams;
...
import com.creanger.app.ui.Components.FlatCheckBox;
...
public class StatisticActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        ArrayList<GlassTabView> tabViews = new ArrayList<>(2);
        if (hasStats) {
        ...
        showTabs = hasStats && hasMonetization;
        if (showTabs && startFromMonetization) {
...
//            loadData(viewData);
    ...
    private void checkUi_actionBar() {
        ...
        if (currentPage == monetizationLayout) {
