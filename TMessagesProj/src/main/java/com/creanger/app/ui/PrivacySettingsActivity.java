...
public class PrivacySettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        listView.setOnItemClickListener((view, position) -> {
            ...
            if (position == autoDeleteMesages) {
                ...
                // Creanger: Blocked Users preserved.
                presentFragment(new PrivacyUsersActivity());
            } else if (position == sessionsRow) {
                // Creanger: Telegram session management hidden.
                ...
                // Creanger: Active Telegram websites/sessions hidden.
                if (BuildConfig.USE_CREANGER_AUTH) return;
                ...
                // Creanger: secret-chat webpage preview hidden.
                if (BuildConfig.USE_CREANGER_AUTH) return;
                ...
                // Creanger: secret-chat location alerts hidden.
                if (BuildConfig.USE_CREANGER_AUTH) return;
    ...
    public void updateRows(boolean notify) {
        ...
        if (BuildConfig.USE_CREANGER_AUTH) {
            // Creanger: hide Telegram-only privacy rows; Blocked Users (blockedRow) stays visible.
            // Sessions / web sessions / 2FA / secret-chat rows are Telegram server/DC-only.
            sessionsRow = -1;
            sessionsDetailRow = -1;
            webSessionsRow = -1;
            passwordRow = -1;
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public boolean isEnabled(RecyclerView.ViewHolder holder) {
            ...
            return position == passcodeRow || position == passwordRow || position == passkeysRow || position == blockedRow || position == sessionsRow || position == secretWebpageRow || position == webSessionsRow ||
                    ...
                    position == contactsDeleteRow ||
                    position == contactsSuggestRow || position == autoDeleteMesages;
        }
