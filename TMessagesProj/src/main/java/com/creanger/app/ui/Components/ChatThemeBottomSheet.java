...
import com.creanger.app.ui.ActionBar.theme.ThemeKey;
    ...
    private void updateState(boolean animated) {
        if (!dataLoaded) {
            ...
            if (hasChanges()) {
                ...
                updateApplySubTextTranslation(false, animated && applyTextView.getAlpha() > .8f);
                AndroidUtilities.updateViewVisibilityAnimated(chooseBackgroundTextView, false, 0.9f, false, animated);
                AndroidUtilities.updateViewVisibilityAnimated(cancelOrResetTextView, false, 0.9f, false, animated);
                ...
                AndroidUtilities.updateViewVisibilityAnimated(applySubTextView, false, 0.9f, false, 0.7f, animated, null);
