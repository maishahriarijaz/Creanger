...
import com.creanger.app.ui.Components.PhotoBubbleClip;
...
import com.creanger.app.ui.Components.StatusDrawable;
...
import com.creanger.app.ui.Components.dialogs.DialogMediaIconsHelper;
...
import com.creanger.app.ui.RightSlidingDialogContainer;
                ...
                if (chat != null) {
                    if (useFromUserAsAvatar) {
                        ...
                        if (chat2 != null) {
                            ...
                            sb.setSpan(new BadgeSpan.TextSpan(getString(R.string.MonoforumSpan), 9.33f, Theme.key_windowBackgroundWhiteGrayText, resourcesProvider), index, sb.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                            nameString = sb;
                        } else {
