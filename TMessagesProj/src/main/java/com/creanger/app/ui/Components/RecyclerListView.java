...
//        drawSectionsBackgrounds(canvas);
    ...
    public void setSections(int padding, float roundRadius, boolean topPadding) {
        setSections(
            view -> !(view instanceof TextInfoPrivacyCell || view instanceof ShadowSectionCell || view instanceof GraySectionCell || view instanceof CollapseTextCell) && !Objects.equals(view.getTag(), TAG_NOT_SECTION),
            padding,
            roundRadius,
