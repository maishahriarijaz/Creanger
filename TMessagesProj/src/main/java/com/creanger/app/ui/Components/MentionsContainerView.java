...
import com.creanger.app.ui.Adapters.MentionsAdapter;
import com.creanger.app.ui.Adapters.PaddedListAdapter;
...
public class MentionsContainerView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void dispatchDraw(@NonNull Canvas canvas) {
        ...
        boolean topPadding = (adapter.isStickers() || adapter.isBotContext()) && adapter.isMediaLayout();
