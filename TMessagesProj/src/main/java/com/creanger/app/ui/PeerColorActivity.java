...
import static com.creanger.app.messenger.AndroidUtilities.distance;
...
import com.creanger.app.ui.Components.FilledTabsView;
        ...
        public boolean hasUnsavedChanged() {
            if (isChannel) {
                ...
                if (type == PAGE_NAME) {
                    ...
                    return !(selectedColor == ChatObject.getProfileColorId(chat) && selectedEmoji == ChatObject.getOnlyProfileEmojiId(chat));
                }
            } else {
                ...
                if (type == PAGE_NAME) {
                    ...
                    return !(selectedColor == UserObject.getProfileColorId(me) && selectedEmoji == UserObject.getOnlyProfileEmojiId(me));
                }
            }
        }
...
//            }
        ...
        public void updateButton(boolean animated) {
            ...
            button.setText(!getUserConfig().isPremium() && !isChannel ? buttonLocked : buttonUnlocked, animated);
...
//        }
    ...
    public static boolean eq(TLRPC.TL_emojiStatusCollectible a, TLRPC.TL_emojiStatusCollectible b) {
        if (a == b) return true;
