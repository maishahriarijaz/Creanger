...
import static com.creanger.app.messenger.AndroidUtilities.isContextSafe;
...
import com.creanger.app.messenger.pip.PipSource;
import com.creanger.app.messenger.pip.source.IPipSourceDelegate;
...
//        }
    ...
    public View pipCreatePictureInPictureView() {
        return new View(fragment != null ? fragment.getContext() : null);
    }
