...
import com.creanger.app.ui.ChannelAdminLogActivity;
import com.creanger.app.ui.ChatBackgroundDrawable;
...
import com.creanger.app.ui.Components.CommunityAvatarDrawable;
...
import com.creanger.app.ui.Components.SuggestBirthdayActionLayout;
import com.creanger.app.ui.Components.Text;
import com.creanger.app.ui.Components.TopicSeparator;
...
import com.creanger.app.ui.GradientClip;
...
import com.creanger.app.ui.Stories.StoriesUtilities;
import com.creanger.app.ui.Stories.UploadingDotsSpannable;
...
public class ChatActionCell extends BaseCell implements DownloadController.FileDownloadProgressListener, NotificationCenter.NotificationCenterDelegate, IMessageCell {
    ...
    public void setMessageObject(MessageObject messageObject, boolean force) {
        ...
        } else if (messageObject.type == MessageObject.TYPE_GIFT_STARS || messageObject.type == MessageObject.TYPE_GIFT_PREMIUM || messageObject.type == MessageObject.TYPE_GIFT_PREMIUM_CHANNEL || messageObject.type == MessageObject.TYPE_SHARING_OFFER) {
    ...
    private void openStarsGiftTransaction() {
        ...
        if (currentMessageObject.messageOwner.action instanceof TLRPC.TL_messageActionGiftTon) {
    ...
    private void createLayout(CharSequence text, int width) {
        ...
        invalidatePath = true;
        TextPaint paint;
        if (isMessageActionSuggestedPostApproval() || currentMessageObject != null && (currentMessageObject.type == MessageObject.TYPE_SHARING_OFFER)) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (birthdayLayout != null) {
            ...
            } else if (currentMessageObject.type == MessageObject.TYPE_GIFT_PREMIUM) {
            ...
            if (isNewStyleButtonLayout()) {
                ...
                if (giftPremiumButtonLayout != null) {
                    ...
                    if (!isMessageActionSuggestedPostApproval() && (messageObject == null || messageObject.type != MessageObject.TYPE_SHARING_OFFER)) {
    ...
    private int getImageSize(MessageObject messageObject) {
        ...
        if (isMessageActionSuggestedPostApproval() || messageObject.type == MessageObject.TYPE_SHARING_OFFER) {
            imageSize = 0;
        }
        return imageSize;
    }
    ...
    private void createGiftPremiumLayouts(CharSequence title, CharSequence subtitle, CharSequence releasedBy, CharSequence text, boolean allowCollapsing, CharSequence button, int ribbonTextDp, CharSequence ribbon, int width, boolean buttonClickableAsImage, boolean hideImage) {
        ...
        } else if (currentMessageObject != null && (isNewStyleButtonLayout() || currentMessageObject.type == MessageObject.TYPE_GIFT_STARS || currentMessageObject.type == MessageObject.TYPE_GIFT_PREMIUM || currentMessageObject.type == MessageObject.TYPE_COMMUNITY_CHANGED)) {
            giftTextPaint.setTextSize(dp(13));
        } else {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isButtonLayout(messageObject)) {
            ...
            if (giftPremiumButtonLayout != null) {
                ...
                if (getMessageObject().type != MessageObject.TYPE_COMMUNITY_CHANGED && getMessageObject().type != MessageObject.TYPE_SUGGEST_PHOTO && getMessageObject().type != MessageObject.TYPE_ACTION_WALLPAPER && getMessageObject().type != MessageObject.TYPE_STORY_MENTION) {
                    starsPath.rewind();
