...
import static com.creanger.app.messenger.ContactsController.findRule;
...
import com.creanger.app.ui.Cells.RadioCell;
import com.creanger.app.ui.Cells.ShadowSectionCell;
import com.creanger.app.ui.Cells.SlideIntChooseView;
...
import com.creanger.app.ui.Cells.TextSettingsCell;
import com.creanger.app.ui.Components.AlertsCreator;
import com.creanger.app.ui.Components.BackgroundGradientDrawable;
...
import com.creanger.app.ui.Components.CircularProgressDrawable;
...
public class PrivacyControlActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, ImageUpdater.ImageUpdaterDelegate {
    ...
    public View createView(Context context) {
        ...
        listView.setOnItemClickListener((view, position) -> {
            if (position == currentPhotoForRestRow) {
                ...
                args.putBoolean("allowMiniapps", false);
                GroupCreateActivity fragment = new GroupCreateActivity(args);
                if (rulesType == PRIVACY_RULES_TYPE_MESSAGES) {
                    fragment.setTitle(getString(R.string.RemoveMessageFeeTitle));
                }
                fragment.select(createFromArray, position == alwaysShareRow && currentPlusPremium[currentType == TYPE_CONTACTS ? 0 : 1], false);
                fragment.setDelegate((premium, miniapps, ids) -> {
                    if (position == neverShareRow) {
                        currentMinus = ids;
                        currentPlusMiniapps[currentType] = false;
    ...
    private void checkPrivacy() {
        ...
        currentPlusMiniapps[TYPE_NOBODY] =    initialPlusMiniapps[TYPE_NOBODY] =    false;
        ...
        currentPlusChannels[TYPE_NOBODY] =    initialPlusChannels[TYPE_NOBODY] =    false;
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public boolean isEnabled(RecyclerView.ViewHolder holder) {
            ...
            return position == p2pRow && !ContactsController.getInstance(currentAccount).getLoadingPrivacyInfo(ContactsController.PRIVACY_RULES_TYPE_P2P) ||
                    ...
                    (position == nobodyRow || position == myContactsRow || position == payRow || position == everybodyRow || position == neverShareRow || position == alwaysShareRow);
        }
