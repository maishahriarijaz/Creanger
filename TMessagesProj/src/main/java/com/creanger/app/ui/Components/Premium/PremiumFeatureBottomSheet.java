...
import com.creanger.app.ui.Components.BottomPagesView;
...
import com.creanger.app.ui.Components.FeatureCells;
...
public class PremiumFeatureBottomSheet extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public PremiumFeatureBottomSheet(BaseFragment fragment, Context context, int currentAccount, boolean business, int startType, boolean onlySelectedType, PremiumPreviewFragment.SubscriptionTier subscriptionTier, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (startType == PremiumPreviewFragment.FEATURE_GIFTS) {
            premiumButtonView.setOverlayText(getString(R.string.Understood), true, false);
...
//                }
    ...
    private class ViewPage extends LinearLayout {
        ...
        void setFeatureDate(PremiumPreviewFragment.PremiumFeatureData featureData) {
            ...
            if (withFeatures && featuresLayout == null) {
                ...
                final FeatureCells.FeatureCell[] featureCells = new FeatureCells.FeatureCell[3];

                featureCells[0] = new FeatureCells.FeatureCell(getContext(), true, resourcesProvider);
                ...
                featureCells[1] = new FeatureCells.FeatureCell(getContext(), true, resourcesProvider);
                ...
                featureCells[2] = new FeatureCells.FeatureCell(getContext(), true, resourcesProvider);
    ...
    View getViewForPosition(Context context, int position) {
        ...
        if (featureData.type == PremiumPreviewFragment.PREMIUM_FEATURE_STORIES) {
            final int type = FeaturesPageView.FEATURES_STORIES;
