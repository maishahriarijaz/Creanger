...
public class BlurringShader {
    ...
    public void draw(float[] oesMatrix, int texture, int textureWidth, int textureHeight) {
        ...
        com.creanger.app.ui.Components.Paint.Shader.SetColorUniform(p.gradientTopHandle, gradientTop);
        com.creanger.app.ui.Components.Paint.Shader.SetColorUniform(p.gradientBottomHandle, gradientBottom);
