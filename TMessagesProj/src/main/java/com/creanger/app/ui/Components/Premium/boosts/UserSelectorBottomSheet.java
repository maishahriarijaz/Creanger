...
import com.creanger.app.ui.Components.Premium.boosts.adapters.SelectorAdapter;
import com.creanger.app.ui.Components.Premium.boosts.adapters.SelectorAdapter.Item;
import com.creanger.app.ui.Components.Premium.boosts.cells.selector.SelectorBtnCell;
import com.creanger.app.ui.Components.Premium.boosts.cells.selector.SelectorHeaderCell;
import com.creanger.app.ui.Components.Premium.boosts.cells.selector.SelectorSearchCell;
import com.creanger.app.ui.Components.Premium.boosts.cells.selector.SelectorUserCell;
...
public class UserSelectorBottomSheet extends BottomSheetWithRecyclerListView implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void checkEditTextHint() {
        if (!selectedIds.isEmpty() || type == TYPE_STARS || type == TYPE_TRANSFER || type == TYPE_CALL) {
            if (!isHintSearchText) {
...
//        }
        ...
        searchField.setHintText(getString(!selectedIds.isEmpty() || type == TYPE_STARS || type == TYPE_TRANSFER || type == TYPE_CALL ? R.string.Search : R.string.GiftPremiumUsersSearchHint), false);
...
if (type == TYPE_PREMIUM) {
    ...
    private void next() {
        if (selectedIds.size() == 0 || paymentOptions.isEmpty() && (type != TYPE_PREMIUM && type != TYPE_CALL)) {
            return;
        }
    ...
    public void updateItems(boolean animated, boolean notify) {
        ...
        if (isSearching()) {
            ...
            if (type == TYPE_PREMIUM && userFull != null && userFull.birthday == null) {
                h += dp(50);
