...
import static com.creanger.app.messenger.AndroidUtilities.ilerp;
import static com.creanger.app.messenger.AndroidUtilities.lerp;
import static com.creanger.app.messenger.ContactsController.PRIVACY_RULES_TYPE_ADDED_BY_PHONE;
import static com.creanger.app.messenger.LocaleController.formatPluralString;
import static com.creanger.app.messenger.LocaleController.formatPluralStringComma;
...
import com.creanger.app.PhoneFormat.PhoneFormat;
...
import com.creanger.app.messenger.AuthTokensHelper;
...
import com.creanger.app.messenger.FlagSecureReason;
import com.creanger.app.messenger.ImageLoader;
import com.creanger.app.messenger.ImageLocation;
import com.creanger.app.messenger.ImageReceiver;
import com.creanger.app.messenger.LanguageDetector;
...
import com.creanger.app.messenger.NotificationsController;
...
import com.creanger.app.tgnet.tl.TL_bots;
...
import com.creanger.app.ui.ActionBar.ActionBarMenuSubItem;
import com.creanger.app.ui.ActionBar.ActionBarPopupWindow;
import com.creanger.app.ui.ActionBar.AlertDialog;
import com.creanger.app.ui.ActionBar.BackDrawable;
...
import com.creanger.app.ui.ActionBar.OKLCH;
...
import com.creanger.app.ui.Cells.AboutLinkCell;
import com.creanger.app.ui.Cells.AnimatedStatusView;
import com.creanger.app.ui.Cells.CheckBoxCell;
import com.creanger.app.ui.community.CommunityArrowDrawable;
import com.creanger.app.ui.community.cells.CommunityLinkView;
import com.creanger.app.ui.Cells.DividerCell;
import com.creanger.app.ui.Cells.GraySectionCell;
import com.creanger.app.ui.Cells.HeaderCell;
import com.creanger.app.ui.Cells.NotificationsCheckCell;
import com.creanger.app.ui.Cells.ProfileChannelCell;
import com.creanger.app.ui.Cells.SettingsSearchCell;
import com.creanger.app.ui.Cells.SettingsSuggestionCell;
import com.creanger.app.ui.Cells.ShadowSectionCell;
import com.creanger.app.ui.Cells.TextCell;
import com.creanger.app.ui.Cells.TextCheckCell;
import com.creanger.app.ui.Cells.TextDetailCell;
import com.creanger.app.ui.Cells.TextInfoPrivacyCell;
import com.creanger.app.ui.Cells.UserCell;
import com.creanger.app.ui.Components.AlertsCreator;
import com.creanger.app.ui.Components.AnimatedColor;
import com.creanger.app.ui.Components.AnimatedEmojiDrawable;
import com.creanger.app.ui.Components.AnimatedEmojiSpan;
import com.creanger.app.ui.Components.AnimatedFileDrawable;
import com.creanger.app.ui.Components.AnimatedFloat;
import com.creanger.app.ui.Components.AnimatedTextView;
import com.creanger.app.ui.Components.AnimationProperties;
import com.creanger.app.ui.Components.AudioPlayerAlert;
import com.creanger.app.ui.Components.AutoDeletePopupWrapper;
import com.creanger.app.ui.Components.AvatarDrawable;
import com.creanger.app.ui.Components.BackButtonMenu;
...
import com.creanger.app.ui.Components.ButtonBounce;
import com.creanger.app.ui.Components.CanvasButton;
import com.creanger.app.ui.Components.ChatActivityInterface;
import com.creanger.app.ui.Components.ChatAvatarContainer;
import com.creanger.app.ui.Components.ChatNotificationsPopupWrapper;
import com.creanger.app.ui.Components.ColoredImageSpan;
import com.creanger.app.ui.Components.CombinedDrawable;
import com.creanger.app.ui.Components.CrossfadeDrawable;
import com.creanger.app.ui.Components.CubicBezierInterpolator;
import com.creanger.app.ui.Components.DotDividerSpan;
import com.creanger.app.ui.Components.EmojiPacksAlert;
import com.creanger.app.ui.Components.EmptyStubSpan;
import com.creanger.app.ui.Components.FloatingDebug.FloatingDebugController;
import com.creanger.app.ui.Components.Forum.ForumUtilities;
import com.creanger.app.ui.Components.HintView;
import com.creanger.app.ui.Components.HintsController;
import com.creanger.app.ui.Components.IdenticonDrawable;
import com.creanger.app.ui.Components.ImageUpdater;
import com.creanger.app.ui.Components.InstantCameraView;
import com.creanger.app.ui.Components.ItemOptions;
import com.creanger.app.ui.Components.JoinGroupAlert;
import com.creanger.app.ui.Components.LayoutHelper;
import com.creanger.app.ui.Components.LinkSpanDrawable;
import com.creanger.app.ui.Components.MediaActivity;
import com.creanger.app.ui.Components.MessagePrivateSeenView;
import com.creanger.app.ui.Components.ProfileActionsView;
import com.creanger.app.ui.Components.ProfileGalleryBlurView;
import com.creanger.app.ui.Components.Paint.PersistColorPalette;
import com.creanger.app.ui.Components.Premium.LimitPreviewView;
import com.creanger.app.ui.Components.Premium.PremiumFeatureBottomSheet;
import com.creanger.app.ui.Components.Premium.PremiumGradient;
import com.creanger.app.ui.Components.Premium.PremiumPreviewBottomSheet;
import com.creanger.app.ui.Components.Premium.ProfilePremiumCell;
import com.creanger.app.ui.Components.Premium.boosts.UserSelectorBottomSheet;
import com.creanger.app.ui.Components.ProfileGalleryView;
import com.creanger.app.ui.Components.ProfileGooeyView;
import com.creanger.app.ui.Components.ProfileMusicView;
...
import com.creanger.app.ui.Components.Reactions.ReactionsLayoutInBubble;
import com.creanger.app.ui.Components.RecyclerListView;
import com.creanger.app.ui.Components.ScaleStateListAnimator;
import com.creanger.app.ui.Components.ScamDrawable;
import com.creanger.app.ui.Components.ShareAlert;
import com.creanger.app.ui.Components.SharedMediaLayout;
import com.creanger.app.ui.Components.SizeNotifierFrameLayout;
import com.creanger.app.ui.Components.StarRatingView;
import com.creanger.app.ui.Components.StickerEmptyView;
import com.creanger.app.ui.Components.TagEditCell;
import com.creanger.app.ui.Components.TimerDrawable;
import com.creanger.app.ui.Components.TranslateAlert2;
import com.creanger.app.ui.Components.TypefaceSpan;
import com.creanger.app.ui.Components.UItem;
import com.creanger.app.ui.Components.UndoView;
import com.creanger.app.ui.Components.VectorAvatarThumbDrawable;
...
import com.creanger.app.ui.Components.voip.VoIPHelper;
import com.creanger.app.ui.Gifts.GiftSheet;
import com.creanger.app.ui.Stars.BotStarsActivity;
import com.creanger.app.ui.Stars.BotStarsController;
import com.creanger.app.ui.Stories.ProfileStoriesView;
import com.creanger.app.ui.Stories.StoriesController;
import com.creanger.app.ui.Stories.StoriesListPlaceProvider;
import com.creanger.app.ui.Stories.StoryViewer;
import com.creanger.app.ui.Stories.recorder.ButtonWithCounterView;
import com.creanger.app.ui.Stories.recorder.DualCameraView;
import com.creanger.app.ui.Stories.recorder.HintView2;
import com.creanger.app.ui.Stories.recorder.StoryRecorder;
import com.creanger.app.ui.community.CommunitySheet;
...
//                    args.putString("addToGroupAlertString", LocaleController.formatString("AddToTheGroupAlertText", R.string.AddToTheGroupAlertText, UserObject.getUserName(user), "%1$s"));
                    ...
                    // Creanger: end-to-end encrypted Telegram secret chat flow hidden.
                    if (BuildConfig.USE_CREANGER_AUTH) return;
                    AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity(), resourcesProvider);
                    ...
                    if (pressCount >= 2 || BuildVars.DEBUG_PRIVATE_VERSION) {
                        ...
                        builder.setItems(items, (dialog, which) -> {
                            if (which == 0) { // (removed)
                                ...
                                editor = prefs.edit();
                                editor.remove("peerColors").remove("profilePeerColors").remove("bizbothint").remove("movecaptionhint");
    ...
    public void showStatusSelect() {
        ...
        SelectAnimatedEmojiDialog popupLayout = new SelectAnimatedEmojiDialog(this, getContext(), true, Math.max(0, ecenter), currentChat == null ? SelectAnimatedEmojiDialog.TYPE_EMOJI_STATUS : SelectAnimatedEmojiDialog.TYPE_EMOJI_STATUS_CHANNEL, true, resourcesProvider, topMarginDp) {
            ...
            protected void onEmojiSelected(View emojiView, Long documentId, TLRPC.Document document, TL_stars.TL_starGiftUnique gift, Integer until) {
                ...
                getMessagesController().updateEmojiStatus(currentChat == null ? 0 : -currentChat.id, emojiStatus, null);
                for (int a = 0; a < 2; ++a) {
...
//                            .show();
    ...
    public void updateSelectedMediaTabText() {
        ...
        // Preloader may legitimately be null (e.g. Creanger self profile) —
        // fall back to empty counts instead of crashing.
        int[] mediaCount = sharedMediaPreloader != null
                ? sharedMediaPreloader.getLastMediaCount()
...
//                infoEndRowEmpty = rowCount++;
        ...
        if (listView != null) {
            listView.setTranslateSelectorPosition(-1);
        }
        if (actionsView != null) {
        ...
        if (userId != 0) {
            ...
            if (UserObject.isUserSelf(user)) {
                ...
                if (!UserObject.isDeleted(user) && !isBot && currentEncryptedChat == null && !userBlocked && userId != 333000 && userId != 777000 && userId != 42777) {
                    // Creanger: Telegram gifts + secret chats hidden; Blocked Users/report flows preserved elsewhere.
                    if (!BuildConfig.USE_CREANGER_AUTH && !BuildVars.IS_BILLING_UNAVAILABLE && !user.self && !user.bot && !MessagesController.isSupportUser(user) && !getMessagesController().premiumPurchaseBlocked()) {
            ...
            if (ChatObject.isChannel(chat)) {
                ...
                if (chatInfo != null) {
                    if ((chatInfo.can_view_stats || chatInfo.can_view_revenue || getMessagesController().getStoriesController().canPostStories(getDialogId())) && topicId == 0) {
                        otherItem.addSubItem(statistics, R.drawable.msg_stats, LocaleController.getString(R.string.Statistics));
                    }
                    voiceChatAction = false;
                }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                ...
                case VIEW_TYPE_PREMIUM_TEXT_CELL:
                    view = new ProfilePremiumCell(mContext, 0, resourcesProvider);
            ...
            switch (holder.getItemViewType()) {
                ...
                case VIEW_TYPE_TEXT_DETAIL:
                    ...
                    if (position == birthdayRow) {
                        ...
                        detailCell.setTextAndValue(text, LocaleController.getString(R.string.PhoneMobile), false);
                    } else if (position == noteRow) {
                        ...
                        detailCell.setTextAndValue(text, alsoUsernamesString(username, usernames, value), infoEndRowEmpty == -1 && isTopic && birthdayRow < 0);
                    } else if (position == locationRow) {
                ...
                case VIEW_TYPE_TEXT2:
                    ...
                    if (position == unofficialSecurityRiskRow) {
                        final SpannableStringBuilder sb = new SpannableStringBuilder("âš ï¸");
                ...
                case VIEW_TYPE_TEXT:
                    ...
                    if (position == settingsTimerRow) {
                        ...
                        textCell.setTextAndValueAndIcon(getString(R.string.ChannelStars), ssb, R.drawable.menu_feature_paid, true);
                    } else if (position == botTonBalanceRow) {
                        ...
                        textCell.setTextAndValueAndIcon(getString(R.string.BotBalanceTON), ChannelMonetizationLayout.replaceTON(ssb, textCell.getTextView().getPaint()), R.drawable.outline_gram_24, true);
                    } else if (position == blockedUsersRow) {
                        if (chatInfo != null) {
                        ...
                        textCell.setTextAndCheckAndColorfulIcon(LocaleController.getString(R.string.BotProfilePermissionEmojiStatus), userInfo != null && userInfo.bot_can_manage_emoji_status, R.drawable.filled_access_sleeping, getThemedColor(Theme.key_color_lightblue), false);
                    }
        ...
        public int getItemViewType(int position) {
            if (position == infoHeaderRow || position == membersHeaderRow || position == settingsSectionRow2 ||
                ...
                return VIEW_TYPE_ABOUT_LINK;
                    ...
                    position == botTonBalanceRow || position == channelBalanceRow || position == botPermissionEmojiStatus
            ) {
...
//        }
    ...
    private void showStarRatingBottomSheet(View ignoreView) {
        ...
        }
        {
            ...
            button.setText(getString(R.string.Understood), false);
